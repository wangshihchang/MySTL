#ifndef _MYSTL_UNORDERED_MAP_H_
#define _MYSTL_UNORDERED_MAP_H_
...
class unordered_map {
   ...
   public:
    ...
    iterator insert(const_iterator hint, value_type&& value) { return ht_.emplace_unique_use_hint(hint, MySTL::move(value)); }

    template <class Iter>
    void insert(Iter first, Iter last) { ht_.insert_unique(first, last); }
...
class unordered_multimap {
   ...
   public:
    ...
    template <class... Args>
    iterator emplace_hint(const_iterator hint, Args&&... args) { return ht_.emplace_multi_use_hint(hint, MySTL::forward<Args>(args)...); }
    ...
    iterator insert(const_iterator hint, value_type&& value) { return ht_.emplace_multi_use_hint(hint, MySTL::move(value)); }
    ...
    pair<const_iterator, const_iterator> equal_range(const key_type& key) const { return ht_.equal_range_multi(key); }
