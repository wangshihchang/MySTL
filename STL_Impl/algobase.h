...
OuputIter unchecked_copy_cat(InputIter first, InputIter last, OuputIter result, MySTL::input_iterator_tag) {
...
OuputIter unchecked_copy_cat(RandomIter first, RandomIter last, OuputIter result, MySTL::random_access_iterator_tag) {
...
template <class InputIter, class OuputIter>
OuputIter copy(InputIter first, InputIter last, OuputIter result) {
...
RandomIter2 unchecked_copy_backward_cat(RandomIter1 first,
                                        RandomIter2 last,
...
// input_iterator_tag 版本
template <class InputIter, class OuputIter>
OuputIter unchecked_move_cat(InputIter first, InputIter last, OuputIter result, MySTL::input_iterator_tag) {
    for (; first != last; ++first, ++result) {
...
// ramdom_access_iterator_tag 版本
template <class RandomIter, class OuputIter>
OuputIter unchecked_move_cat(RandomIter first, RandomIter last, OuputIter result, MySTL::random_access_iterator_tag) {
    for (auto n = last - first; n > 0; --n, ++first, ++result) {
        *result = MySTL::move(*first);
    }
    return result;
